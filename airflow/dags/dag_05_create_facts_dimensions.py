...
with DAG(
    ...
    description='Create Facts and Dimensions Tables',
    ...
    create_fact_dimensions_task = SSHOperator(
        task_id='create_fact_dimensions',
        ...
        command = f"""
            ...
            /opt/bitnami/spark/bin/spark-submit \
                ...
                --driver-memory 1g \
                --name gold \
                /opt/spark/work-dir/gold_spark_job.py""",
    )    
        

begin >> create_fact_dimensions_task >> end